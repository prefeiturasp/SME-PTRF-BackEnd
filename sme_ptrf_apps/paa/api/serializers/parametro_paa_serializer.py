...
class ParametroPaaSerializer(serializers.ModelSerializer):
    texto_pagina_paa_ue = serializers.CharField(error_messages={
    ...
    introducao_do_paa_ue_2 = serializers.CharField(error_messages={
        'null': ('O campo Introdução 2 da aba Relatórios não foi informado.'),
        'blank': ('O campo Introdução 2 da aba Relatórios não foi informado.')})

    conclusao_do_paa_ue_1 = serializers.CharField(error_messages={
        'null': ('O campo Conclusão do PAA 1 não foi informado.'),
        'blank': ('O campo Conclusão do PAA 1 não foi informado.')})

    conclusao_do_paa_ue_2 = serializers.CharField(error_messages={
        'null': ('O campo Conclusão da aba Relatórios não foi informado.'),
        'blank': ('O campo Conclusão da aba Relatórios não foi informado.')})
