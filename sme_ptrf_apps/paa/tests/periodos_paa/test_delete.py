...
def test_delete_periodo_com_paa_vinculado(jwt_authenticated_client_sme, flag_paa, periodo_paa_1, paa):
    ...
    assert response.data["mensagem"] == (
        "Este período de PAA não pode ser excluído porque está sendo utilizada em um Plano Anual de Atividades (PAA).")
