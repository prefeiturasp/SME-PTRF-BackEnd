...
def test_resultado_periodo_com_receitas(
    ...
    receita_2020_1_role_repasse_livre_conferida,
    receita_2020_1_role_rendimento_livre_conferida,
    ...
    total_receitas_livre_esperado = receita_2020_1_role_rendimento_livre_conferida.valor + \
                                      receita_2020_1_role_repasse_livre_conferida.valor

    total_repasses_livre_esperado = receita_2020_1_role_repasse_livre_conferida.valor
    ...
    esperados = [
        ...
        ('total_receitas_livre', total_receitas_livre_esperado),
        ('total_repasses_livre', total_repasses_livre_esperado),
    ]
