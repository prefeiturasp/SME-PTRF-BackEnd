...
@pytest.fixture
def df_periodo_2019_2(periodo_factory):
...
@pytest.fixture
def df_periodo_2020_1(periodo_factory, df_periodo_2019_2):
    return periodo_factory(
        referencia='2020.1',
...
@pytest.fixture
def df_periodo_2020_2(periodo_factory, df_periodo_2020_1):
    return periodo_factory(
        referencia='2020.2',
...
@pytest.fixture
def df_periodo_2021_1(periodo_factory, df_periodo_2020_2):
    return periodo_factory(
        referencia='2021.1',
