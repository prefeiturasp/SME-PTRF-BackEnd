...
def test_api_inicia_prestacao_conta(client, periodo, associacao):
    associacao_uuid = associacao.uuid
    periodo_uuid = periodo.uuid

    url = f'/api/prestacoes-contas/iniciar/?associacao_uuid={associacao_uuid}&periodo_uuid={periodo_uuid}'
...
def test_api_inicia_prestacao_conta_sem_periodo(client, periodo, associacao):
    associacao_uuid = associacao.uuid

    url = f'/api/prestacoes-contas/iniciar/?associacao_uuid={associacao_uuid}'
...
def test_api_inicia_prestacao_conta_sem_associacao(client, periodo, associacao):
    periodo_uuid = periodo.uuid
