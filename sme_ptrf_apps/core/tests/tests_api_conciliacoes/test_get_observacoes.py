...
def test_api_get_observacoes_sem_observacoes_e_encerramento(jwt_authenticated_client_a,
    ...
    assert result['data_extrato'] == periodo_2020_1.data_fim_realizacao_despesas.strftime("%Y-%m-%d")
...
def test_api_get_sem_observacoes_e_encerramento(jwt_authenticated_client_a,
    ...
    url = f'/api/conciliacoes/observacoes/?periodo={periodo.uuid}&conta_associacao={conta_associacao.uuid}&associacao={conta_associacao.associacao.uuid}'
