...
@pytest.fixture
def usuario_dre_teste_falha_geracao_pc(
    dre_teste_teste_falha_geracao_pc,
):
    senha = 'Sgp0418'
    login = '7654321'
    ...
    user.unidades.add(dre_teste_teste_falha_geracao_pc)
...
def periodo_teste_falha_geracao_pc(periodo_anterior_teste_falha_geracao_pc):
    return baker.make(
        ...
        periodo_anterior=periodo_anterior_teste_falha_geracao_pc,
    )


@pytest.fixture
def dre_teste_teste_falha_geracao_pc():
    return baker.make(
        'Unidade',
        codigo_eol='108500',
        tipo_unidade='DRE',
...
@pytest.fixture
def unidade_teste_falha_geracao_pc(dre_teste_teste_falha_geracao_pc):
    return baker.make(
        'Unidade',
        nome='Escola Teste',
        tipo_unidade='CEU',
        codigo_eol='123456',
        dre=dre_teste_teste_falha_geracao_pc,
    )


@pytest.fixture
def associacao_teste_falha_geracao_pc(unidade_teste_falha_geracao_pc):
    return baker.make(
        'Associacao',
        nome='Escola Teste',
        cnpj='52.302.275/0001-83',
        unidade=unidade_teste_falha_geracao_pc,
    )


@pytest.fixture
def prestacao_conta_teste_falha_geracao_pc(
    periodo_teste_falha_geracao_pc,
    associacao_teste_falha_geracao_pc
):
    return baker.make(
        'PrestacaoConta',
        periodo=periodo_teste_falha_geracao_pc,
        associacao=associacao_teste_falha_geracao_pc,
    )


@pytest.fixture
def falha_geracao_pc_teste_falha_geracao_pc_01(
    ...
    return baker.make(
        'FalhaGeracaoPc',
        ultimo_usuario=usuario_dre_teste_falha_geracao_pc,
        associacao=associacao_teste_falha_geracao_pc,
        periodo=periodo_teste_falha_geracao_pc,
