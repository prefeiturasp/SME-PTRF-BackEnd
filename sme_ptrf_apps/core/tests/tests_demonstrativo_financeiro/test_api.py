...
def test_previa_demonstrativo_financeiro(jwt_authenticated_client_a, periodo, conta_associacao, acao_associacao, fechamento_periodo):
...
def test_previa_demonstrativo_financeiro_data_fim_menor_que_data_inicio(jwt_authenticated_client_a, periodo, conta_associacao, acao_associacao, fechamento_periodo):
    data_inicio = "2019-09-01"
    data_fim = "2019-08-09"
    url = f"/api/demonstrativo-financeiro/previa/?conta-associacao={conta_associacao.uuid}&acao-associacao={acao_associacao.uuid}&periodo={periodo.uuid}&data_inicio={data_inicio}&data_fim={data_fim}"
    response = jwt_authenticated_client_a.get(url)
...
def test_previa_demonstrativo_financeiro_data_fim_maior_que_data_final_periodo(jwt_authenticated_client_a, periodo, conta_associacao, acao_associacao, fechamento_periodo):
    data_inicio = "2019-09-01"
    data_fim = "2019-12-08"
    url = f"/api/demonstrativo-financeiro/previa/?conta-associacao={conta_associacao.uuid}&acao-associacao={acao_associacao.uuid}&periodo={periodo.uuid}&data_inicio={data_inicio}&data_fim={data_fim}"
    response = jwt_authenticated_client_a.get(url)
...
def test_previa_demonstrativo_financeiro_sem_data_inicio_e_data_fim(jwt_authenticated_client_a, periodo, conta_associacao, acao_associacao, fechamento_periodo):
    data_inicio = ""
    data_fim = ""
    url = f"/api/demonstrativo-financeiro/previa/?conta-associacao={conta_associacao.uuid}&acao-associacao={acao_associacao.uuid}&periodo={periodo.uuid}&data_inicio={data_inicio}&data_fim={data_fim}"
    response = jwt_authenticated_client_a.get(url)
