...
def test_status_periodo_conciliado(associacao, periodo_2020_1, prestacao_conta_2020_1_conciliada):
    ...
    assert status == status_esperado, 'períodos com prestações conciliadas devem ter status conciliado.'
