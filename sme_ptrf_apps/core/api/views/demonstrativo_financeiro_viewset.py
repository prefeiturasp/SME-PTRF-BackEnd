    ...
    dados_demonstrativo = {
        ...
        'identificacao_conta': {'banco': 'Banco do Brasil', 'agencia': '7370', 'conta': '12345-6',
            ...
            'resumo_acoes': [{'acao_associacao': 'Rolê Cultural',
                             ...
                             {'acao_associacao': 'Ação ABC',
                              ...
                              'linha_capital': {
                                  ...
                                  'despesa_realizada': 0,
                                  'despesa_nao_realizada': 0,
                                  'despesa_nao_demostrada_outros_periodos': Decimal(
                                      '300.00'),
                                  'saldo_reprogramado_proximo': 0,
                                  'saldo_reprogramado_proximo_vr': 0,
                                  'saldo_bancario': Decimal(
                                      '300.00'),
                                  'valor_saldo_reprogramado_proximo_periodo_capital': 0,
                                  'valor_saldo_bancario_capital': Decimal(
                                      '300.00'),
                                  'credito_nao_demonstrado': 0},
                              'linha_livre': {
                                  'saldo_anterior': '',
            ...
            'total_valores': {'saldo_anterior': {'C': 0, 'K': 0, 'L': 0}, 'credito': {'C': 0, 'K': 0, 'L': 0},
                              ...
                              'despesa_nao_demostrada_outros_periodos': {'C': Decimal('2638.85'),
                                                                         'K': Decimal('1377.77'),
                                                                         'L': 0}, 'saldo_bancario': Decimal('3905.51'),
        ...
        'despesas_anteriores_nao_demonstradas': {'linhas': [
            {'razao_social': 'Fornecedor 01', 'cnpj_cpf': '51.510.540/0001-56',
             'tipo_documento': 'Guia de Recolhimento',
            ...
            {'razao_social': 'Fornecedor Ollyver', 'cnpj_cpf': '007.461.987-01', 'tipo_documento': 'NFe',
             ...
             'valor': Decimal('250.00')}, {'razao_social': 'Fornecedor Ollyver', 'cnpj_cpf': '36.352.197/0001-75',
                                           ...
                                           'data_documento': '01/07/2020',
                                           'data_transacao': '31/12/2020', 'valor': Decimal('333.33')},
            ...
            {'razao_social': 'Fornecedor 01', 'cnpj_cpf': '51.510.540/0001-56',
             'tipo_documento': 'Guia de Recolhimento',
             'numero_documento': '202004', 'nome_acao_documento': 'Recurso Externo', 'especificacao_material': '',
             'tipo_despesa': 'CUSTEIO', 'tipo_transacao': '', 'data_documento': '26/05/2021',
             'data_transacao': '26/05/2021', 'valor': Decimal('777.76')},
            {'razao_social': 'Fornecedor 01', 'cnpj_cpf': '51.510.540/0001-56',
             'tipo_documento': 'Guia de Recolhimento',
             'numero_documento': '202004', 'nome_acao_documento': 'Recurso Externo', 'especificacao_material': '',
             'tipo_despesa': 'CUSTEIO', 'tipo_transacao': '', 'data_documento': '02/06/2021',
             'data_transacao': '02/06/2021', 'valor': Decimal('777.76')}], 'valor_total': Decimal('4016.62')},
