...
from ...models import FalhaGeracaoPc, Associacao
from drf_spectacular.utils import extend_schema_view
from .docs.falhas_geracao_pc_docs import DOCS
...
class FalhaGeracaoPcViewSet(viewsets.ModelViewSet):
    ...
    def info_registro_falha_geracao_pc(self, request):
        from ..serializers.validation_serializers.falha_geracao_pc_validation_serializer import (
            FalhaGeracaoPcValidationSerializer)
