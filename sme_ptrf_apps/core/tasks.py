...
from sme_ptrf_apps.core.models import PrestacaoConta, AcaoAssociacao, FechamentoPeriodo, ContaAssociacao, Associacao, Periodo
...
def concluir_prestacao_de_contas_async(periodo_uuid, associacao_uuid):
    from sme_ptrf_apps.core.services.prestacao_contas_services import _criar_fechamentos, _criar_documentos
