...
class Notificacao(ModeloBase):
    ...
    CATEGORIA_NOTIFICACAO_GERACAO_ATA = 'GERACAO_ATA'
    CATEGORIA_NOTIFICACAO_CONCLUSAO_PC = 'CONCLUSAO_PC'
    ...
    CATEGORIA_NOTIFICACAO_NOMES = {
        ...
        CATEGORIA_NOTIFICACAO_GERACAO_ATA: 'Geração de Ata',
        CATEGORIA_NOTIFICACAO_CONCLUSAO_PC: 'Conclusão da PC',
    }
    ...
    CATEGORIA_NOTIFICACAO_CHOICES = (
        ...
        (CATEGORIA_NOTIFICACAO_GERACAO_ATA, CATEGORIA_NOTIFICACAO_NOMES[CATEGORIA_NOTIFICACAO_GERACAO_ATA]),
        (CATEGORIA_NOTIFICACAO_CONCLUSAO_PC, CATEGORIA_NOTIFICACAO_NOMES[CATEGORIA_NOTIFICACAO_CONCLUSAO_PC]),
    )
