...
class Notificacao(ModeloBase):
    ...
    CATEGORIA_NOTIFICACAO_DEVOLUCAO_CONSOLIDADO_APOS_PRAZO_VENCIMENTO = 'DEVOLUCAO_CONSOLIDADO_VENCIMENTO'
    ...
    CATEGORIA_NOTIFICACAO_NOMES = {
        ...
        CATEGORIA_NOTIFICACAO_DEVOLUCAO_CONSOLIDADO_APOS_PRAZO_VENCIMENTO: 'Devolução de relatório consolidado'
    }
    ...
    CATEGORIA_NOTIFICACAO_CHOICES = (
        ...
        (CATEGORIA_NOTIFICACAO_DEVOLUCAO_CONSOLIDADO_APOS_PRAZO_VENCIMENTO, CATEGORIA_NOTIFICACAO_NOMES[CATEGORIA_NOTIFICACAO_DEVOLUCAO_CONSOLIDADO_APOS_PRAZO_VENCIMENTO]),
    )
