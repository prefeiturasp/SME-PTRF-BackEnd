...
class TipoAcertoDocumento(ModeloIdNome):
    ...
    CATEGORIA_EDICAO_INFORMACAO = 'EDICAO_INFORMACAO'
    ...
    CATEGORIA_NOMES = {
        ...
        CATEGORIA_EDICAO_INFORMACAO: 'Edição de informação',
    }
    ...
    CATEGORIA_CHOICES = (
        ...
        (CATEGORIA_EDICAO_INFORMACAO, CATEGORIA_NOMES[CATEGORIA_EDICAO_INFORMACAO])
    )
