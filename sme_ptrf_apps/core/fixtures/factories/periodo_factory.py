...
class PeriodoFactory(DjangoModelFactory):
    ...
    data_inicio_realizacao_despesas = LazyFunction(
    ...
    data_fim_realizacao_despesas = LazyAttribute(
        lambda obj: obj.data_inicio_realizacao_despesas + timedelta(days=120)
    )

    referencia = LazyAttribute(
