from sme_ptrf_apps.core.choices.tipos_carga import (CARGA_PERIODO_INICIAL, CARGA_REPASSE_REALIZADO,
                                                    ...
                                                    CARGA_MATERIAIS_SERVICOS, CARGA_CONTAS_ASSOCIACOES
                                                    )
...
def processa_carga(arquivo):
    ...
    elif arquivo.tipo_carga == CARGA_CONTAS_ASSOCIACOES:
        CargaContasAssociacoesService().carrega_contas_associacoes(arquivo)
