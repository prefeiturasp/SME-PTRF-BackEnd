...
def teste_cargos_composicao_create(
...
@override_flag('historico-de-membros', active=True)
def teste_cargos_composicao_create_deve_retornar_erro_data_inicio_no_cargo_menor_que_data_inicio_composicao(
    composicao_01_2023_a_2025,
    ocupante_cargo_01,
    payload_create_cargo_composicao_01_deve_passar,
    jwt_authenticated_client_sme,
...
@override_flag('historico-de-membros', active=True)
def teste_cargos_composicao_create_deve_retornar_erro_data_inicio_no_cargo_maior_que_data_fim_composicao(
    composicao_01_2023_a_2025,
    ocupante_cargo_01,
    payload_create_cargo_composicao_01_deve_passar,
    jwt_authenticated_client_sme,
...
@override_flag('historico-de-membros', active=True)
def teste_cargos_composicao_create_deve_retornar_erro_data_inicio_no_cargo_maior_que_data_fim_no_cargo(
    composicao_01_2023_a_2025,
    ocupante_cargo_01,
    payload_create_cargo_composicao_01_deve_passar,
    jwt_authenticated_client_sme,
...
@override_flag('historico-de-membros', active=True)
def teste_cargos_composicao_create_deve_retornar_erro_duplicidade_codigo_identificacao(
    composicao_01_2023_a_2025,
    ocupante_cargo_01,
    ocupante_cargo_02,
    cargo_composicao_01,
...
@override_flag('historico-de-membros', active=True)
def teste_cargos_composicao_create_deve_retornar_erro_duplicidade_cpf_responsavel(
    composicao_01_2023_a_2025,
    ocupante_cargo_01,
    ocupante_cargo_02,
    cargo_composicao_01,
