    ...
    responses={
        200: OpenApiResponse(
            response=inline_serializer(
                name="ConsultaCodigoIdentificacaoSmeIntegracaoVacanciaResponse",
                fields={
...
SCHEMA_GET_CARGOS_DO_RF_NO_SMEINTEGRACAO = extend_schema(
    ...
    responses={
        200: OpenApiResponse(
            response=inline_serializer(
                name="GetCargosDoRfSmeIntegracaoVacanciaResponse",
                fields={
                    ...
                    "cargos": inline_serializer(
                        name="CargoDoRfSmeIntegracaoVacanciaResponse",
                        many=True,
                        fields={
