...
def test_action_acompanahmento_de_relatorios_consolidados(
    ...
    response = jwt_authenticated_client_dre.get(
        f'/api/consolidados-dre/acompanhamento-de-relatorios-consolidados-sme/?periodo={periodo_uuid}',
...
def test_action_acompanahmento_de_relatorios_consolidados_periodo_errado(
    jwt_authenticated_client_dre,
    periodo_teste_acompanahmento_de_relatorios_consolidados
):
    periodo_uuid = periodo_teste_acompanahmento_de_relatorios_consolidados.uuid
    ...
    response = jwt_authenticated_client_dre.get(
        f'/api/consolidados-dre/acompanhamento-de-relatorios-consolidados-sme/?periodo={periodo_uuid}XXX',
        content_type='application/json'
    )
...
def test_action_acompanahmento_de_relatorios_consolidados_sem_periodo(
    jwt_authenticated_client_dre,
):

    response = jwt_authenticated_client_dre.get(
        f'/api/consolidados-dre/acompanhamento-de-relatorios-consolidados-sme/',
        content_type='application/json'
    )
