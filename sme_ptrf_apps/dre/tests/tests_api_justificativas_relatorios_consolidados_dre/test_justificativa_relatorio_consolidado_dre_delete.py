...
def test_delete_cobranca_prestacao_conta(jwt_authenticated_client_relatorio_consolidado, justificativa_relatorio_dre_consolidado):
    ...
    response = jwt_authenticated_client_relatorio_consolidado.delete(
