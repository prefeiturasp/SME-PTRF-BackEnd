...
@pytest.fixture
def periodo_anterior_teste_model_consolidado_dre(periodo_factory):
...
@pytest.fixture
def periodo_teste_model_consolidado_dre(periodo_factory, periodo_anterior_teste_model_consolidado_dre):
    return periodo_factory(
        referencia='2022.1',
