...
def test_retorna_trilha_de_status_pc_aprovada_ressalvas_retificada(
...
def test_retorna_trilha_de_status_pc_reprovada_retificada(
    dre_teste_service_consolidado_dre,
    periodo_teste_service_consolidado_dre,
    prestacao_conta_reprovada_consolidado_dre_retificado,
    consolidado_dre_teste_service_consolidado_dre_retificado,
):
    dre_uuid = dre_teste_service_consolidado_dre.uuid
    periodo_uuid = periodo_teste_service_consolidado_dre.uuid
...
def test_retorna_trilha_de_status_pc_aprovada_retificada(
    dre_teste_service_consolidado_dre,
    periodo_teste_service_consolidado_dre,
    prestacao_conta_aprovada_consolidado_dre_retificado,
    consolidado_dre_teste_service_consolidado_dre_retificado,
):
    dre_uuid = dre_teste_service_consolidado_dre.uuid
    periodo_uuid = periodo_teste_service_consolidado_dre.uuid
