...
def test_list_analises_documentos_consolidado_dre(
    ...
    response = jwt_authenticated_client_sme_teste_analise_documento_consolidado_dre.get(
        f'/api/analises-documentos-consolidados-dre/',
    ...
    esperado = [
        ...
        },
        {
            "analise_consolidado_dre": f"{analise_consolidado_dre_01.uuid}",
            "ata_parecer_tecnico": None,
            "documento_adicional": f"{documento_adicional_consolidado_dre_01.uuid}",
            "relatorio_consolidao_dre": None,
            "detalhamento": "",
            "resultado": "CORRETO",
            "uuid": f"{analise_documento_consolidado_dre_02.uuid}"
        }
    ]
