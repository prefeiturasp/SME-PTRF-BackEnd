...
def verificar_se_gera_ata_parecer_tecnico(dre=None, periodo=None, consolidado_dre=None, usuario=None, ata=None,
                                          parcial=None):
...
def concluir_consolidado_dre_async(
    ...
    from ..services.consolidado_dre_service import atrelar_pc_ao_consolidado_dre, gerar_relatorio_consolidado_dre
    ...
    verificar_se_gera_ata_parecer_tecnico(
        dre=dre,
        periodo=periodo,
        consolidado_dre=consolidado_dre,
        usuario=usuario,
    ...
    gerar_lauda_txt_consolidado_dre(
        consolidado_dre=consolidado_dre,
        dre=dre,
        periodo=periodo,
        parcial=parcial,
    ...
    passar_pcs_do_relatorio_para_publicadas(
        dre=dre,
        periodo=periodo,
        consolidado_dre=consolidado_dre
    )
    ...
    if (eh_parcial):
        verifica_se_relatorio_consolidado_deve_ser_gerado(
            dre=dre,
            periodo=periodo,
            usuario=usuario
        )
