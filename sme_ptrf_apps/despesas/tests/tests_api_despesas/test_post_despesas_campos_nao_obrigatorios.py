...
def test_api_post_despesas_nao_obrigatorias_com_rateios(
    ...
    response = client.post('/api/despesas/', data=json.dumps(payload_despesa_sem_campos_nao_obrigatorios),
...
def test_api_post_despesas_nao_obrigatorias_sem_rateios(
    ...
    response = client.post('/api/despesas/', data=json.dumps(payload_despesa_sem_campos_nao_obrigatorios_sem_rateios),
                           content_type='application/json')
