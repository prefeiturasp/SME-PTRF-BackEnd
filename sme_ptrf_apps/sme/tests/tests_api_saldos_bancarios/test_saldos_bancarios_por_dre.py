...
def test_saldo_bancario_por_dre_com_conta_nao_iniciada(jwt_authenticated_client_sme,
    ...
    observacao = observacao_conciliacao_factory.create(data_extrato=None, saldo_extrato=1000, periodo=periodo_saldos_bancarios, associacao=associacao, conta_associacao=conta_associacao_nao_iniciada)
