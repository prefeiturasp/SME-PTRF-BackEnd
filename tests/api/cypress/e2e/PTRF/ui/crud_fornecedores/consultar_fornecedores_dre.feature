...
Funcionalidade: consultar fornecedor
  ...
  Esquema do Cenário: Validar pesquisa de fornecedor :<caso>
    ...
    Exemplos:
      ...
      | web          | teste automatizado |        84434384791    | teste automatizado              | 84434384791             |   informando dados em todos os campos com valor cpf      |
      | web          | teste automatizado |        17863885000155 | teste automatizado              | 17863885000155          |   informando dados em todos os campos com valor cnpj     |
      | web          |                    |        17863885000155 | teste automatizado              | 17863885000155          |   informando dados somente no campo de cnpj              |
      | web          |                    |        84434384791    | teste automatizado              | 84434384791             |   informando dados somente no campo de cpf               |
      | web          | teste automatizado |                       | teste automatizado              | 84434384791             |   informando dados somente no campo de nome              |