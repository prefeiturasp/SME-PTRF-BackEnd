...
Funcionalidade: Excluir Tipo de Conta
  ...
  Esquema do Cenário: Validar exclusâo de tipo conta:<caso>
    ...
    E clico no botao "Editar" da tela tipo de conta na tabela com a opcao 'teste automatizado'
    ...
    Exemplos:
      | visualizacao | opcao_painel_parametrizacao | mensagem                                                       | caso        | mensagem_de_confirmacao_de_erro               | 
      | web          | Tipo                        |  O tipo de conta foi removido do sistema com sucesso.          | com sucesso | Deseja realmente excluir este Tipo de Conta?  |